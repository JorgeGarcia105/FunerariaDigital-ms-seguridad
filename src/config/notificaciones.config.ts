export namespace ConfiguracionNotificaciones {
  ...
  export const urlNotificaciones2fa: string = "http://localhost:5093/Notificaciones/enviar-correo";
  export const urlNotificacionesSms: string = "http://localhost:5093/Notificaciones/enviar-sms";
