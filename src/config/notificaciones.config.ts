export namespace ConfiguracionNotificaciones {
  ...
  export const urlNotificaciones2fa: string = "http://localhost:5132/Notificaciones/enviar-correo";//"http://localhost:5000/email";//
  export const urlNotificacionesSms: string = "http://localhost:5132/Notificaciones/enviar-sms";//"http://localhost:5000/sms";//
